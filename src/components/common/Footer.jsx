                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 md:gap-18 ">
                        ...
                        <div>
                            ...
                            <ul className="space-y-3">
                                <li><Link href="/about" className="text-gray-300 text-sm hover:text-prbg-primary transition-colors">About Us</Link></li>
                                <li><Link href="/terms" className="text-gray-300 text-sm hover:text-prbg-primary transition-colors">Terms & Conditions</Link></li>
                                <li><Link href="/privacy" className="text-gray-300 text-sm hover:text-prbg-primary transition-colors">Privacy Policy</Link></li>
                            </ul>
                        </div>
                        ...
                        <div>
                            ...
                            <ul className="space-y-3">
                                <li><Link href="/faq" className="text-gray-300 text-sm hover:text-prbg-primary transition-colors">FAQs</Link></li>
                                <li><Link href="/help" className="text-gray-300 text-sm hover:text-prbg-primary transition-colors">Help & Support</Link></li>
                                <li><Link href="/contact" className="text-gray-300 text-sm hover:text-prbg-primary transition-colors">Contact Us</Link></li>
                            </ul>
                        </div>
                        ...
                        <div className="flex flex-col lg:flex-row justify-between items-center gap-4">
                            <div className="flex space-x-6">
                                <Link href="#" aria-label="Instagram" className="w-8 h-8 border border-gray-600 rounded-full flex items-center justify-center hover:bg-prbg-primary hover:border-prbg-primary transition-colors">
                                    <Instagram className="w-4 h-4 text-gray-300 hover:text-black transition-colors" />
                                </Link>
                                <Link href="#" aria-label="Twitter" className="w-8 h-8 border border-gray-600 rounded-full flex items-center justify-center hover:bg-prbg-primary hover:border-prbg-primary transition-colors">
                                    <Twitter className="w-4 h-4 text-gray-300 hover:text-black transition-colors" />
                                </Link>
                                <Link href="#" aria-label="Facebook" className="w-8 h-8 border border-gray-600 rounded-full flex items-center justify-center hover:bg-prbg-primary hover:border-prbg-primary transition-colors">
                                    <Facebook className="w-4 h-4 text-gray-300 hover:text-black transition-colors" />
                                </Link>
                                <Link href="#" aria-label="YouTube" className="w-8 h-8 border border-gray-600 rounded-full flex items-center justify-center hover:bg-prbg-primary hover:border-prbg-primary transition-colors">
                                    <Youtube className="w-4 h-4 text-gray-300 hover:text-black transition-colors" />
                                </Link>
